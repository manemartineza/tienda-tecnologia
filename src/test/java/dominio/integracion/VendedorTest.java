...
public class VendedorTest {
	...
	private static final String NOMBRECLIENTE = "Pedro Hernandez";
	...
	public void generarGarantiaTest() {
		...
		// act
		vendedor.generarGarantia(producto.getCodigo(),producto.getNombre(),producto.getPrecio(),NOMBRECLIENTE);		
